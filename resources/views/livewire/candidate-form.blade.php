                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="R2" class="form-label">Nome do Candidato <span class="text-danger">*</span></label>
                                    <input wire:model.defer="data.R2" class="form-control" type="text" placeholder="" maxlength="50" required autofocus autocomplete="off">
                                    @error("data.R2")
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="Nome_Pai" class="form-label">Nome do Pai <span class="text-danger">*</span></label>
                                    <input wire:model.defer="data.Nome_Pai" class="form-control" type="text" placeholder="" maxlength="50" required autofocus autocomplete="off">
                                    @error("data.Nome_Pai")
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-2">
                                <div class="form-group">
                                    ...
                                    <input wire:model.defer="data.Numero" class="form-control" type="number" placeholder="" maxlength="15" required autofocus autocomplete="off">
                                    @error("data.Numero")
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="R1" class="form-label">Cópia da Certidão de Casamento </label>
                                    <input wire:model.defer="data.R1" class="form-control" type="file">
                                    @error("data.R1")
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="R3" class="form-label">Foto <span class="text-danger">*</span></label>
                                    <input wire:model.defer="data.R3" class="form-control" type="file" accept="image/*" required>
                                    @error("data.R3")
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input wire:model.defer="data.R5" class="form-control" type="text" placeholder="" maxlength="8" required autofocus autocomplete="off">
                                    @error("data.R5")
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input wire:model.defer="data.R6" class="form-control" type="text" placeholder="" maxlength="1" autofocus autocomplete="off">
                                    @error("data.R6")
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select wire:model.defer="data.R7" class="form-control">
                                        <option value="">Selecione...</option>
                                        <option value="Sim">Sim</option>
                                        <option value="Não">Não</option>
                                    </select>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select wire:model.defer="data.R9" class="form-control">
                                        <option value="">Selecione...</option>
                                        <option value="Sim">Sim</option>
                                        <option value="Não">Não</option>
                                    </select>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="R11" class="form-label">Em caso da IPB, qual a data do Batismo? </label>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input wire:model.defer="data.R13" class="form-control" type="text" placeholder="" maxlength="50" autofocus autocomplete="off">
                                    @error("data.R13")
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="R14" class="form-label">Em caso da IPB, qual a data da Profissão de Fé? </label>
                                    <input wire:model.defer="data.R14" class="form-control" type="date" placeholder="" autofocus autocomplete="off">
                                    @error("data.R14")
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input wire:model.defer="data.R15" class="form-control" type="text" placeholder="" maxlength="80" required autofocus autocomplete="off">
                                    @error("data.R15")
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select wire:model.defer="data.R18" required class="form-control">
                                        <option value="">Selecione...</option>
                                        <option value="Sim">Sim</option>
                                        <option value="Não">Não</option>
                                    </select>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input wire:model.defer="data.R21" class="form-control" type="text" placeholder="" maxlength="50" autofocus autocomplete="off">
                                    @error("data.R21")
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select wire:model.defer="data.R22" class="form-control">
                                        <option value="">Selecione...</option>
                                        <option value="Sim">Sim</option>
                                        <option value="Não">Não</option>
                                    </select>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="R23" class="form-label">Em caso de Outra Igreja Evangélica, qual a data do Batismo? </label>
                                    <input wire:model.defer="data.R23" class="form-control" type="date" placeholder="" autofocus autocomplete="off">
                                    @error("data.R23")
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input wire:model.defer="data.R24" class="form-control" type="text" placeholder="" maxlength="50" autofocus autocomplete="off">
                                    @error("data.R24")
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select wire:model.defer="data.R16" required class="form-control">
                                        <option value="">Selecione...</option>
                                        <option value="Sim">Sim</option>
                                        <option value="Não">Não</option>
                                    </select>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input wire:model.defer="data.R17" class="form-control" type="text" placeholder="" maxlength="100" autofocus autocomplete="off">
                                    @error("data.R17")
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="R25" class="form-label">Por qual(ais) razão(ões) deixou ou deseja transferir-se da sua ex-Igreja? </label>
                                    <textarea wire:model.defer="data.R25" class="form-control" rows="3" autofocus autocomplete="off"></textarea>
                                    @error("data.R25")
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="R26" class="form-label">Como você conheceu a Igreja Presbiteriana de Cuiabá (IPC)? </label>
                                    <textarea wire:model.defer="data.R26" class="form-control" rows="3" autofocus autocomplete="off"></textarea>
                                    @error("data.R26")
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select wire:model.defer="data.R28" required class="form-control">
                                        <option value="">Selecione...</option>
                                        <option value="Sim">Sim</option>
                                        <option value="Não">Não</option>
                                    </select>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input wire:model.defer="data.R29" class="form-control" type="text" placeholder="" autofocus autocomplete="off">
                                    @error("data.R29")
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select wire:model.defer="data.R30" required class="form-control">
                                        <option value="">Selecione...</option>
                                        <option value="Sim">Sim</option>
                                        <option value="Não">Não</option>
                                    </select>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select wire:model.defer="data.R31" class="form-control">
                                        <option value="">Selecione...</option>
                                        <option value="Sim">Sim</option>
                                        <option value="Não">Não</option>
                                    </select>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select wire:model.defer="data.R32" required class="form-control">
                                        <option value="">Selecione...</option>
                                        <option value="Sim">Sim</option>
                                        <option value="Não">Não</option>
                                    </select>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input wire:model.defer="data.R33" class="form-control" type="text" placeholder="" required autofocus autocomplete="off">
                                    @error("data.R33")
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select wire:model.defer="data.R34" required class="form-control">
                                        <option value="">Selecione...</option>
                                        <option value="Sim">Sim</option>
                                        <option value="Não">Não</option>
                                    </select>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input wire:model.defer="data.R35" class="form-control" type="text" placeholder="" autofocus autocomplete="off">
                                    @error("data.R35")
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select wire:model.defer="data.R36" required class="form-control">
                                        <option value="">Selecione...</option>
                                        <option value="Sim">Sim</option>
                                        <option value="Não">Não</option>
                                    </select>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input wire:model.defer="data.R37" class="form-control" type="text" placeholder="" maxlength="100" autofocus autocomplete="off">
                                    @error("data.R37")
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select wire:model.defer="data.R38" class="form-control">
                                        <option value="">Selecione...</option>
                                        <option value="Sim">Sim</option>
                                        <option value="Não">Não</option>
                                    </select>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input wire:model.defer="data.R39" class="form-control" type="text" placeholder="" maxlength="100" required autofocus autocomplete="off">
                                    @error("data.R39")
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="R40" class="form-label">O quanto você conhece da história, do sistema de doutrina e governo da Igreja Presbiteriana do Brasil? <span class="text-danger">*</span></label>
                                    <textarea wire:model.defer="data.R40" class="form-control" rows="3" required autofocus autocomplete="off"></textarea>
                                    @error("data.R40")
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="R42" class="form-label">Em caso afirmativo, qual (ais) são as suas dúvidas e/ou resistências? </label>
                                    <textarea wire:model.defer="data.R42" class="form-control" rows="3" autofocus autocomplete="off"></textarea>
                                    @error("data.R42")
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="R45" class="form-label">Qual a sua situação hoje? <span class="text-danger">*</span></label>
                                    <textarea wire:model.defer="data.R45" class="form-control" rows="3" required autofocus autocomplete="off"></textarea>
                                    @error("data.R45")
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="R46" class="form-label">I - Sociedades Internas & Ministérios <span class="text-danger">*</span></label>
                                    <textarea wire:model.defer="data.R46" class="form-control" rows="3" required autofocus autocomplete="off"></textarea>
                                    @error("data.R46")
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="R47" class="form-label">II - Departamento de Responsabilidade Social <span class="text-danger">*</span></label>
                                    <textarea wire:model.defer="data.R47" class="form-control" rows="3" required autofocus autocomplete="off"></textarea>
                                    @error("data.R47")
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                ...
                <div class="card-body">
                    <form wire:submit.prevent="submit">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="Nome_Mae" class="form-label">Nome do Pai <span class="text-danger">*</span></label>
                                    <input wire:model.defer="data.Nome_Pai" class="form-control" type="text" placeholder="" maxlength="50" required autofocus autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="Fone_Celular" class="form-label">Telefone Comercial <span class="text-danger">*</span></label>
                                    <input wire:model.defer="data.Fone_Celular" x-mask='(99)9 9999-9999' class="form-control" type="text" placeholder="" maxlength="50" required autofocus autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="Data_Nasc_F4" class="form-label">Data de Nascimento do 4º Filho </label>
                                    <input wire:model.defer="data.Data_Nasc_F4" class="form-control" type="date" placeholder=""  required autofocus autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="R3" class="form-label">Foto <span class="text-danger">*</span></label>
                                    <input wire:model.defer="data.R3" class="form-control" type="file" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="R11" class="form-label">Em caso de Outra Igreja Evangélica, qual a data do Batismo? </label>
                                    <input wire:model.defer="data.R23" class="form-control" type="date" placeholder="" autofocus autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="R25" class="form-label">Como você conheceu a Igreja Presbiteriana de Cuiabá (IPC)? </label>
                                    <textarea wire:model.defer="data.R26" class="form-control" rows="3" autofocus autocomplete="off"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="R25" class="form-label">O quanto você conhece da história, do sistema de doutrina e governo da Igreja Presbiteriana do Brasil? <span class="text-danger">*</span></label>
                                    <textarea wire:model.defer="data.R40" class="form-control" rows="3" required autofocus autocomplete="off"></textarea>
                                </div>
                            </div>
