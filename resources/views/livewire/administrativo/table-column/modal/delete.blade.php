<x-modal.modal-message :visibleModal=$showModalDelete wire:key="showModalDelete" >
    ...
    <x-slot name="body">
    	<div class="modal-body">
			<h6 class="modal-title text-black mb-9">Deseja realmente excluir a Tabela Coluna </h6>
		</div>
    </x-slot>
    <x-slot name="footer">
        <button type="button" wire:click="destroy" class="btn btn-primary">Confirmar</button>
