<x-modal.modal-message :visibleModal=$showModalDelete wire:key="showModalDelete" >
    ...
    <x-slot name="body">
    	<div class="modal-body">
			<h6 class="modal-title text-black mb-9">Deseja realmente excluir o usuário {{ $data['name'] }}</h6>
		</div>
    </x-slot>
    <x-slot name="footer">
        <button type="button" wire:click="destroy" class="btn btn-primary">Excluir Usuário</button>
